...
The REST API documentation can be found [on platform.openai.com](https://platform.openai.com/docs). The full API of this library can be found in [api.md](https://pypi.org/project/openai/api.md).
...
The full API of this library can be found in [api.md](https://pypi.org/project/openai/api.md).
...
Note that requests that time out are [retried twice by default](https://pypi.org/project/openai/#retries).
